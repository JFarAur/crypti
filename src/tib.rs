...
pub const MEM_REGION_TIB: u8 = 0x1u8 << 1;
pub const MEM_REGION_PEB: u8 = 0x1u8 << 2;
pub const MEM_REGION_LDR: u8 = 0x1u8 << 3;

pub const TIB_ABSOLUTE_ADDRESS: u64 = 0x1000;
pub const PEB_ABSOLUTE_ADDRESS: u64 = 0x3000;
pub const LDR_ABSOLUTE_ADDRESS: u64 = 0x4000;
